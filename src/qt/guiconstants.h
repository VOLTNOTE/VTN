...
/* voltnote GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VOLTNOTE"
#define QAPP_ORG_DOMAIN "voltnote.org"
#define QAPP_APP_NAME_DEFAULT "VOLTNOTE-Qt"
#define QAPP_APP_NAME_TESTNET "VOLTNOTE-Qt-testnet"
