...
/** Utility functions used by the VOLTNOTE Qt UI.
 */
namespace GUIUtil
{
...
// Render VOLTNOTE addresses in monospace font
...
// Parse "voltnote:" URI into recipient object, return true on successful parsing
