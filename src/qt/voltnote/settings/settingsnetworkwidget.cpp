...
#include "qt/voltnote/settings/settingsnetworkwidget.h"
#include "qt/voltnote/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/voltnote/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(VOLTNOTEGUI* _window, QWidget *parent) :
