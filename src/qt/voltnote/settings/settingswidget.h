...
#include <QWidget>
#include "qt/voltnote/pwidget.h"
#include "qt/voltnote/settings/settingsbackupwallet.h"
#include "qt/voltnote/settings/settingsexportcsv.h"
#include "qt/voltnote/settings/settingsbittoolwidget.h"
#include "qt/voltnote/settings/settingssignmessagewidgets.h"
#include "qt/voltnote/settings/settingswalletrepairwidget.h"
#include "qt/voltnote/settings/settingswalletoptionswidget.h"
#include "qt/voltnote/settings/settingsmainoptionswidget.h"
#include "qt/voltnote/settings/settingsdisplayoptionswidget.h"
#include "qt/voltnote/settings/settingsmultisendwidget.h"
#include "qt/voltnote/settings/settingsinformationwidget.h"
#include "qt/voltnote/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(VOLTNOTEGUI* parent);
    ~SettingsWidget();
