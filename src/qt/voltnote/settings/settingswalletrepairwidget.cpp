...
#include "qt/voltnote/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/voltnote/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VOLTNOTEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to VOLTNOTEGUI::handleRestart()
