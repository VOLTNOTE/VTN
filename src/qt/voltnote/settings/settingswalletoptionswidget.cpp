...
#include "qt/voltnote/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/voltnote/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(VOLTNOTEGUI* _window, QWidget *parent) :
