...
#include "qt/voltnote/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(VOLTNOTEGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("VOLTNOTE_tx_csv_export(*.csv)") : tr("VOLTNOTE_addresses_csv_export(*.csv)"),
        nullptr);
