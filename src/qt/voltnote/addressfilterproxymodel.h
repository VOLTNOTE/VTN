...
#ifndef VOLTNOTE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define VOLTNOTE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //VOLTNOTE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
