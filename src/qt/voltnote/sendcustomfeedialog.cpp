...
#include "qt/voltnote/sendcustomfeedialog.h"
#include "qt/voltnote/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VOLTNOTEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VOLTNOTEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
