...
#include "qt/voltnote/topbar.h"
#include "qt/voltnote/forms/ui_topbar.h"
#include "qt/voltnote/lockunlock.h"
#include "qt/voltnote/qtutils.h"
#include "qt/voltnote/receivedialog.h"
#include "qt/voltnote/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/voltnote/balancebubble.h"
...
TopBar::TopBar(VOLTNOTEGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopVtn, ui->labelAmountTopShieldedVtn}, "amount-small-topbar");
    setCssProperty({ui->labelAmountVtn}, "amount-topbar");
    setCssProperty({ui->labelPendingVtn, ui->labelImmatureVtn}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("VOLTNOTE")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // VTN Total
    QString totalVtn = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // VTN
    // Top
    ui->labelAmountTopVtn->setText(totalTransparent);
    ui->labelAmountTopShieldedVtn->setText(totalShielded);
    // Expanded
    ui->labelAmountVtn->setText(totalVtn);
    ui->labelPendingVtn->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureVtn->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
