...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, VOLTNOTEGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, VOLTNOTEGUI* gui, double posX = 3);
