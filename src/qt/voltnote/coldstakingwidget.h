...
#include "qt/voltnote/furabstractlistitemdelegate.h"
#include "qt/voltnote/txviewholder.h"
#include "qt/voltnote/tooltipmenu.h"
#include "qt/voltnote/sendmultirow.h"
#include "qt/voltnote/coldstakingmodel.h"
#include "qt/voltnote/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(VOLTNOTEGUI* parent);
    ~ColdStakingWidget();
