...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            VOLTNOTEGUI* window = static_cast<VOLTNOTEGUI*>(parentWidget());
...
{
    VOLTNOTEGUI* gui = static_cast<VOLTNOTEGUI*>(parentWidget());
...
{
    hide();
    static_cast<VOLTNOTEGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("VOLTNOTE will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your VTNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
