...
public:
    ...
    /**
     * Amount of voltnote coming in to a transaction
...
// VOLTNOTE: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
