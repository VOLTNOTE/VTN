...
extern const char * const VOLTNOTE_CONF_FILENAME;
extern const char * const VOLTNOTE_PID_FILENAME;
extern const char * const VOLTNOTE_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("voltnote-%s", name);
