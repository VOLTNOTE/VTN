...
#ifndef VOLTNOTE_STAKEINPUT_H
#define VOLTNOTE_STAKEINPUT_H
...
class CVtnStake : public CStakeInput
{
private:
...
public:
    CVtnStake(const CTxOut& _from, const COutPoint& _outPointFrom, const CBlockIndex* _pindexFrom) :
            CStakeInput(_pindexFrom), outputFrom(_from), outpointFrom(_outPointFrom) {}

    static CVtnStake* NewVtnStake(const CTxIn& txin);
