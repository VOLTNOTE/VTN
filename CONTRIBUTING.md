Contributing to VOLTNOTE
============================

The VOLTNOTE project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/voltnote-project/voltnote/blob/master/doc/translation_process.md)
...
The following applies to code changes to the VOLTNOTE project, and is not to be
confused with overall VOLTNOTE Network Protocol consensus changes.

Whether a pull request is merged into VOLTNOTE rests with the project merge
...
Patches that change VOLTNOTE consensus rules are considerably more involved than
...
Where a patchset proposes to change the VOLTNOTE consensus, it must have been
...
The project leader is the release manager for each VOLTNOTE release.
