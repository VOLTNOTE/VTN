...
from test_framework.test_framework import voltnoteTier2TestFramework
...
class MasternodeGovernanceBasicTest(voltnoteTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.voltnote.org/t/test-proposal"
