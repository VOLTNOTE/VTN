...
"""Verify that starting voltnote with -h works as expected."""
import subprocess

from test_framework.test_framework import voltnoteTestFramework
from test_framework.util import assert_equal

class HelpTest(voltnoteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start voltnote with -? for help text")
        ...
        self.log.info("Start voltnote with -version for version information")
