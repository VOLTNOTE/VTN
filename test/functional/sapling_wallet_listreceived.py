...
class ListReceivedTest (voltnoteTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 VTN.
        ...
        # Send 1 VTN to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 VTN sending them all (fee is 0.1 VTN)
        ...
        # Confirm transaction (2 VTN from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 VTN, send 0.6 VTN + 0.05 VTN fee
