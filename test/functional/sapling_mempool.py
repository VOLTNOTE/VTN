#!/usr/bin/env python3
# Copyright (c) 2020 The VOLTNOTE developers
...
class SaplingMempoolTest(voltnoteTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 VTN note to Alice
        ...
        # miner sends another 10 VTN note to Alice
