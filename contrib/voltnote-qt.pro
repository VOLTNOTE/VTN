...
RESOURCES += src/qt/voltnote.qrc src/qt/voltnote_locale.qrc

TRANSLATIONS += src/qt/locale/voltnote_bg.ts \
                src/qt/locale/voltnote_de.ts \
                src/qt/locale/voltnote_en.ts \
                src/qt/locale/voltnote_es.ts \
                src/qt/locale/voltnote_fi.ts \
                src/qt/locale/voltnote_fr.ts \
                src/qt/locale/voltnote_it.ts \
                src/qt/locale/voltnote_ja.ts \
                src/qt/locale/voltnote_pl.ts \
                src/qt/locale/voltnote_pt.ts \
                src/qt/locale/voltnote_ru.ts \
                src/qt/locale/voltnote_sk.ts \
                src/qt/locale/voltnote_sv.ts \
                src/qt/locale/voltnote_vi.ts \
                src/qt/locale/voltnote_zh_CN.ts \
                src/qt/locale/voltnote_zh_TW.ts
