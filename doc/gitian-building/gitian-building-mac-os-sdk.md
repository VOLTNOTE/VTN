...
The script [extract-osx-sdk.sh](https://github.com/voltnote-project/voltnote/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
voltnote/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/voltnote-project/voltnote/blob/master/doc/README_osx.md) for troubleshooting tips.
