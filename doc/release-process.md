...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/VOLTNOTE/VTN/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/VOLTNOTE/VTN/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/VOLTNOTE/gitian.sigs.git
    git clone https://github.com/VOLTNOTE/VTN-detached-sigs.git
...
- Detached signatures will then be committed to the [voltnote-detached-sigs](https://github.com/VOLTNOTE/VTN-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/VOLTNOTE/VTN/releases/new) with a link to the archived release notes.
