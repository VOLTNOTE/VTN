VOLTNOTE version v5.2.0 is now available from:  <https://github.com/VOLTNOTE/VTN/releases>

This is a new major version release, including various bug fixes and visual improvements.

Please report bugs using the issue tracker at github: <https://github.com/VOLTNOTE/VTN/issues>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/VOLTNOTE-translations/), the QA team during Testing and the Node hosts supporting our Testnet.
